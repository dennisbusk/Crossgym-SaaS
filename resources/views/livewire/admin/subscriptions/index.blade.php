...
{{--        <x-flowbite.link href="{{ route('classes.create') }}" variant="primary">--}}
{{--          {{ __('New Class') }}--}}
{{--        </x-flowbite.button>--}}
      </div>
    </div>
    ...
    <x-flowbite.table>
      <x-flowbite.table.head class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <x-flowbite.table.head.row>
          ...
          <x-flowbite.table.head.cell>{{ __('Stripe Subscription ID') }}</x-flowbite.table.head.cell>
          ...
          <x-flowbite.table.head.cell>{{ __('Current Period End') }}</x-flowbite.table.head.cell>
