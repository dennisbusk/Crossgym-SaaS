    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="p-4 flex w-full justify-end items-center">
            <div class="flex items-center gap-2 justify-self-end">
                ...
                <x-flowbite.link href="{{ route('users.create') }}" variant="primary">
                    {{ __('New User') }}
                </x-flowbite.button>
            </div>
        </div>
...
3. **Model Conventions**
    ...
    - Fields like `name`, `description`, etc. marked as translatable. As defined by `spatie/laravel-translatable`.
    - Factories and seeders for testing.
    - **Model policies** for authorization.
    - Add Model routes to `routes/web.php`.
    - Add Model routes to sidebar in `resources/views/layouts/sidebar.blade.php`.
